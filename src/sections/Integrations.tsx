                ...
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    <div>
                        ...
                        <h2 className="text-6xl font-medium mt-6">
                            Plays will with <span className="text-lime-400">others</span>
                        </h2>
                        <p className="text-white/50 mt-4 text-lg">
                            Layers seamlessly connects with your favorite tools, making easy to plug into any workflow and collaborate across your platforms.
                        </p>
                    </div>
