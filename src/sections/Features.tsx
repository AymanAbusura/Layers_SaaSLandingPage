...
import { Tag, FeatureCard, Avatar, Key } from "../components/index";
            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    <FeatureCard 
                        ...
                        description="Powerfull commands to help you create designs more quickly"
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            ...
                            <Key 
                                className="outline outline-2 outline-offset-4 outline-transparent group-hover:outline-lime-400 transition-all duration-500 group-hover:translate-y-1 delay-150"
                            >
                                alt
                            </Key>
                            <Key 
                                className="outline outline-2 outline-offset-4 outline-transparent group-hover:outline-lime-400 transition-all duration-500 group-hover:translate-y-1 delay-300"
                            >
                                C
                            </Key>
                        </div>
